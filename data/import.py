...
def create_info_file(path, name, country_residence, email, facebook_handle, github_handle, information, last_name, linkedin_handle, position_1, twitter_handle):
    info = """name: {0}
---
country_residence: {1}
---
...
image: profile.png
    ...
    """.format(name, country_residence, email, facebook_handle, github_handle, information, last_name, linkedin_handle, position_1, twitter_handle)
